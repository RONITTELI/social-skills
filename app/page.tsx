  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-center pt-20 pb-24 px-6 overflow-hidden">
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 -z-10"></div>
        
        <div className="max-w-4xl mx-auto">
          {/* Hero Content Card */}
          <div className="relative bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 backdrop-blur-xl rounded-3xl p-12 shadow-[0_20px_60px_rgba(0,0,0,0.15)] border-2 border-white/50 hover:shadow-[0_25px_70px_rgba(0,0,0,0.2)] transition-all duration-300">
            {/* Decorative gradient orbs */}
            <div className="absolute -top-20 -left-20 w-40 h-40 bg-gradient-to-br from-blue-400/30 to-purple-400/30 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-br from-purple-400/30 to-pink-400/30 rounded-full blur-3xl"></div>
            
            <div className="relative z-10">
              <h2 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6 drop-shadow-sm">
                Build Your <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Confidence</span> & Social Skills with AI
              </h2>
              ...
              <Link
                href="/profile"
                className="mt-10 inline-block px-10 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-2xl text-lg font-semibold hover:shadow-2xl hover:scale-105 transition-all shadow-xl relative overflow-hidden group"
              >
